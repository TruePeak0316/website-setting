...
export function CalculatorSwitcher() {
  ...
  return (
    <div className="space-y-8">
      <div className="calculator-switcher rounded-full border border-brand-light/35 bg-white p-1.5 shadow-[0_18px_54px_rgb(7_86_111_/_0.08)]" role="tablist" aria-label="計算小工具切換">

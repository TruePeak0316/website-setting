      ...
      <article className="bg-brand-cream">
        <header className="border-b border-brand-light/25 bg-white">
          <div className="page-shell grid gap-8 py-12 lg:grid-cols-[0.95fr_1.05fr] lg:items-end lg:py-16">
            ...
            <div className="relative overflow-hidden rounded-xs border border-brand-light/30 bg-brand-cream shadow-[0_18px_60px_rgb(74_53_37_/_0.10)]">
              {article.youtube ? (
        ...
        <div className="page-shell py-12 lg:py-16">
          <div className="mx-auto max-w-3xl rounded-xs border border-brand-light/25 bg-white p-6 shadow-[0_18px_60px_rgb(74_53_37_/_0.08)] sm:p-10">

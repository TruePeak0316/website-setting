            ...
            <button
              ...
              className={`group flex w-full items-center gap-3 rounded-xs border p-4 text-left transition duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] active:translate-y-px ${
                activeService.id === service.id
                  ? "translate-x-1 border-brand-primary bg-white shadow-[0_18px_44px_rgb(74_53_37_/_0.12)]"
                  : "border-brand-light/30 bg-white/60 hover:-translate-y-0.5 hover:border-brand-primary/45 hover:bg-white hover:shadow-[0_16px_38px_rgb(74_53_37_/_0.08)]"
              }`}
            >
              <span
...
function MobileServiceAccordionItem({
  ...
  return (
    <article className={`overflow-hidden rounded-xs border bg-white transition duration-300 ${expanded ? "border-brand-primary shadow-[0_18px_52px_rgb(74_53_37_/_0.1)]" : "border-brand-light/30"}`}>
  ...
  return (
    <div className="grid gap-4 lg:gap-5">
      {sections.map((section) => (
        <section key={section.heading} className="rounded-xs border border-brand-light/25 bg-brand-cream/35 p-4 transition duration-300 sm:p-5 lg:hover:-translate-y-0.5 lg:hover:border-brand-primary/30 lg:hover:bg-white lg:hover:shadow-[0_12px_30px_rgb(74_53_37_/_0.07)]">

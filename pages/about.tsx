      ...
      <section className="about-scroll-section section-pad bg-brand-cream">
        <div className="page-shell grid gap-10 lg:grid-cols-[280px_1fr]">
          ...
          <div className="grid gap-5">
            {TIMELINE.map((item) => (
              <article key={item.year} className="about-timeline-card grid gap-4 rounded-xs border border-brand-light/25 bg-white p-6 shadow-[0_14px_40px_rgb(74_53_37_/_0.06)] md:grid-cols-[140px_1fr]">
